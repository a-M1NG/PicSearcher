# tagger by @Akegarasu
# https://github.com/Akegarasu/lora-scripts/blob/main/scripts/stable/finetune/tag_images_by_wd14_tagger.py
import argparse
import csv
import os
...
def main(args):
    ...
    print(os.path.exists(model_location))
    ...
    if args.onnx:
        ...
        model = tf.keras.models.load_model(f"{model_location}")
